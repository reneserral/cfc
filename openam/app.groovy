...
OAuth2ClientOptions opts = new OAuth2ClientOptions([
    site:"http://openam.acme.cat:8080/openam",
...
router.route("/protected")
    ...
    .handler({ routingContext ->
        ...
        user.fetch("http://openam.acme.cat:8080/openam/info/login", { infoResponse ->
            if (infoResponse.failed()) {
                ...
                user.fetch("http://openam.acme.cat:8080/openam/openidm/${userPath}", { userResponse ->
